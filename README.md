...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/lingering-boat-2572#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/lingering-boat-2572
```

A live public deployment of this template is available at [https://lingering-boat-2572.templates.workers.dev](https://lingering-boat-2572.templates.workers.dev)
